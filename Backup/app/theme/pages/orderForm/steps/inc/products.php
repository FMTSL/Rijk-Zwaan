  ...
  <table id="tabela" class="table table-striped mb-0">
    <thead>
      <tr>
        ...
        <th class="" <?php if ($userRoles == 4) : ?>style="color:red;" <?php endif; ?>>Price per MX after Discount
          without ICMS</th>
    ...
    <tfoot>
      <tr>
        ...
        <td><strong>Gross value: R$
            <?= number_format($commercialOrderAllValueNotDiscount->value_not_discount, 2, ',', '.'); ?></strong></td>
        <td><strong>Net value: R$ <?= number_format($commercialOrderAllValue->value_icms, 2, ',', '.'); ?></strong>
        </td>
