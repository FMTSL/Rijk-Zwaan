                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form method="post" id="form" action="<?= url("files/new-action"); ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group position-relative mt-4 pt-1 slug-set">
...
<script type="text/javascript" src="<?= url("theme/assets/js/pages/files.js"); ?>" charset="UTF-8"></script>
<?php $v->end(); ?>
