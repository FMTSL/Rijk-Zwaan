    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" id="form" action="<?= url("billing-term/new"); ?>">
                    <h4 class="card-title text-left">New <?= $title; ?></h4>
                    <hr>
                    <p class="text-left">Cadastro de novos faturamentos</p>
                    <div class="form-group position-relative mb-4 slug-set">
                        <label for="days">Tipo de Faturamento</label>
                        <input type="text" class="form-control " required name="days" id="days" value="">
                    </div>

                    <div class="form-group position-relative mb-4 slug-set">
                        <label for="ticket">Pagamento</label>
                        <input type="text" class="form-control " required name="ticket" id="ticket" value="">
                    </div>
...
<script src="<?= url("theme/assets/js/pages/customerCreditDays.js"); ?>"></script>
<?php $v->end(); ?>
