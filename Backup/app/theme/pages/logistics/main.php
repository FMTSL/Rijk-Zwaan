...
<script src="<?= url("theme/assets/js/jspdf.min2.js"); ?>"></script>
<script src="<?= url("theme/assets/js/html2canvas.min.js"); ?>"></script>
<script src="<?= url("theme/assets/js/pages/logistics.js"); ?>"></script>
