    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" id="form" action="<?= url("sales-unit/new"); ?>">
                    <h4 class="card-title text-left">New <?= $title; ?></h4>
                    <hr>
                    <p class="text-left">Registration of sales unit types</p>
                    ...
                    <div class="form-group position-relative mb-4 slug-set">
                        ...
                        <input type="text" class="form-control " required name="info" id="info" value="">
                    </div>
...
<script src="<?= url("theme/assets/js/pages/salesUnit.js"); ?>"></script>
<?php $v->end(); ?>
