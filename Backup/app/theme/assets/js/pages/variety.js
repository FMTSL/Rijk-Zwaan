...
function update(id) {
  $.get(`/variety/${id}`, function (dd) {
    console.log(dd);
    $("#new").modal("show");
    $("#form #input_name").val(dd.name);
    $("#form #slug").val(dd.slug);
    $("#form #id").val(dd.id);
    $("#form h4").text("Update Variety");
    $("#form p").text(`Update Variety ${dd.name}`);
    $("#form button").text("Update");
    $("#form").attr("action", "/variety/update");
  });
}
...
$.get(`/varieties/lists/all`, function (dd) {
