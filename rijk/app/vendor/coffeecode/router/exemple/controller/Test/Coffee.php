...
class Coffee
{
    ...
    {
        echo "<h3 class="text-3xl">", __METHOD__, "::", $_SERVER["REQUEST_METHOD"], "</h3><hr>";
    ...
    {
        echo "<h3 class="text-3xl">Whoops!</h3>", "<pre>", print_r($data, true), "</pre>";
    }

    public function admin(array $data): void
    {
        echo "<h3 class="text-3xl">Admin Group:</h3>", "<pre>", print_r($data, true), "</pre>";
    }
}