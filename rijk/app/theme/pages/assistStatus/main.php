    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" id="form" action="<?= url("status-pedido/new"); ?>">
                    ...
                    <div class="form-group position-relative mb-4 slug-set">
                        ...
                        <input type="text" class="form-control " required name="status_name" id="status_name" value="">
                    </div>
...
<script src="<?= url("theme/assets/js/pages/assistStatus.js"); ?>"></script>
<?php $v->end(); ?>
