    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" id="form" action="<?= url("credit-term/new"); ?>">
                    <h4 class="card-title text-left">New <?= $title; ?></h4>
                    <hr>
                    <p class="text-left">Payment term Registration</p>
                    <div class="form-group position-relative mb-4 slug-set">
                        <label for="days">Deadline</label>
                        <input type="text" class="form-control " required name="deadline" id="deadline" value="">
                    </div>
                    ...
                    <div class="form-group position-relative mb-4 slug-set">
                        <label for="days">Value</label>
                        <input type="text" class="form-control " required name="valor" id="valor" value="">
                    </div>

                    <div class="form-group position-relative mb-4 slug-set">
                        <label for="type">Customer Category</label>
                        <select class="form-select" id="id_customer_category" name="id_customer_category">
                            <option>Select</option>
                            <?php foreach ($categoryCustomer as $catCustomer) : ?>
                                <option value="<?= $catCustomer->id; ?>"><?= $catCustomer->name; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group position-relative mb-4 slug-set">
                        ...
                        <select class="form-select" id="type_payment" name="type_payment">
                            <option value="0">Select</option>
                            <option value="1">Payment in advance</option>
                            <option value="2">Payment on invoice</option>
                        </select>
                    </div>
...
<script src="<?= url("theme/assets/js/pages/customerCreditDeadline.js"); ?>"></script>
<?php $v->end(); ?>
