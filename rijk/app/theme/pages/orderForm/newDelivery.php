          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <input type="text" id="<?= $customerCategory->id; ?>" name="" class="form-control"
                  value="<?= $customerCategory->name; ?>" disabled>
              </div>
            </div>
            <div class="col-md-4">
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-select" id="payment_type" name="payment_type" disabled>
                      ...
                      <option value="<?= $pagTerm->id; ?>"
                        <?php if ($pagTerm->id == $order->payment_type) : ?>selected<?php endif; ?>>
                        <?= $pagTerm->name; ?>
                      </option>
                      <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group position-relative cash_payment col-md-5"
                  <?php if ($order->payment_type == 1) : ?> style="display: block;" <?php else : ?>
    ...
    <div class="bg-white">
      <div class="card-body">
        <form method="post" id="form" action="<?= url("order-to-order/form/new-finish"); ?>">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-select" id="id_payment_term" name="id_payment_term" required>
                      ...
                      <option value="<?= $tipPag->id; ?>"
                        <?php if ($order->id_payment_term == $tipPag->id) : ?>selected<?php endif; ?>>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-select" id="delivery" name="delivery" required
                      <?php if (!$order->delivery) : ?>disabled<?php endif; ?>>
                      <option value="0">Select</option>
                      <?php foreach ($deliveryType as $dt) : ?>
                      <?php if ($dt->weight > $totalWeight->value) : ?>
                      <option value="<?= $dt->id; ?>"
                        <?php if ($order->delivery == $dt->id) : ?>selected<?php endif; ?>><?= $dt->name; ?>
                      </option>
                      <?php endif; ?>
                      <?php endforeach; ?>
                    </select>
                  ...
                  <div class="form-group delivery_address_label">
                    ...
                    <select class="form-select" id="delivery_address" name="delivery_address" required
                      <?php if (!$order->delivery_address) : ?>disabled<?php endif; ?>>
                      <option value="0">Select</option>
                      ...
                      <option value="<?= $da->id; ?>"
                        <?php if ($order->delivery_address == $da->id) : ?>selected<?php endif; ?>>
                ...
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <textarea name="comment" id="comment" class="form-control" cols="20"
                      rows="10"><?= $order->comments; ?></textarea>
                  </div>
                </div>
              </div>
            </div>
          ...
          <?php endforeach; ?>
          <?php endforeach; ?>
          <input type="hidden" id="id_customer_category" name="id_customer_category" class="form-control"
          ...
          <input type="hidden" id="total_value_db" name="total_value_db"
            value="<?= $total->value_icms + $order->freight; ?>">
          ...
          <?php endif; ?>
          <?php endforeach; ?>
          <input type="hidden" id="quotation" name="quotation" value="">
    ...
    <div class="card">
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-3"> <a class="btn btn-success btn-block btn-lg" id="getOrder">Generate order</a>

          </div>
          <div class="col-md-3 "><a class="btn btn-info btn-block btn-lg" id="getOrderQuotation">Generate Quotation</a>
          </div>
        </div>
      </div>
    </div>
