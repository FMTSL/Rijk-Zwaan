      ...
      <h4>
        ...
        <div id="stepTwoUpdate" class="content" style="display: block;">
          ...
          <div class="table-responsive-w-100">
            <table id="tabela" class="table table-striped mb-0" style="width: 100%;">
              <thead>
                <tr>
                  <th class="">Variety</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-bold-500">R$ <?= number_format($item->quantity * $item->value, 2, ',', '.'); ?>
                  </td>
              ...
              <tfoot>
                <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td colspan="2" style="text-align: right;"><strong>Net value: R$
                      <?= number_format($commercialOrderAllValue->value, 2, ',', '.'); ?></strong></td>
          ...
          <table id="tabela" class="table table-striped mb-0" style="width: 100%;">
            ...
            <tfoot>
              <tr>
                ...
                <td></td>
                <td colspan="2" style="text-align: right;"><strong>Net value: R$
                    <?= number_format($bonnusOrderAllValue->value, 2, ',', '.'); ?></strong>
                </td>
          ...
          <table id="tabela" class="table table-striped mb-0" style="width: 100%;">
            ...
            <tfoot>
              <tr>
                ...
                <td></td>
                <td colspan="2" style="text-align: right;"><strong>Net value: R$
                    <?= number_format($salanovaOrderAllValue->value, 2, ',', '.'); ?></strong>
                </td>
          ...
          <table id="tabela" class="table table-striped mb-0" style="width: 100%;">
            ...
            <tfoot>
              <tr>
                ...
                <td></td>
                <td colspan="2" style="text-align: right;"><strong>Net value: R$
                    <?= number_format($aditionalDiscountOrderAllValue->value, 2, ',', '.'); ?></strong></td>
