  ...
  <div class="card-content">
    <div class="card-body">
      <div class="col-md-12 rounded bg-greenYellow mb-4">
        <form method="post" id="bonusOrder" action="<?= url("order-to-order/carrinho/new-tree"); ?>" class="p-2 bg-cian">
          <input type="hidden" id="cliente_id" name="cliente_id" value="<?= $client->id; ?>">
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="variety" class="w-full">Variety</label>
                <select class="form-select selectSearch w-full" id="variety_bonus_order" name="variety_bonus_order">
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <select class="form-select" id="id_stock_bonus_order" name="id_stock_bonus_order" disabled>
                </select>
              </div>
            </div>
            ...
            <div class="col-md-2">
              <div class="form-group">
                ...
                <input type="text" id="quantity_bonus_order" name="quantity_bonus_order" class="form-control" disabled>
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group position-relative">
                <label for="aditional_discount">Bonus Type</label>
                <select class="form-select" id="bonus_type_bonus_order" name="bonus_type_bonus_order" disabled>
                  <option value="0">Select</option>
            ...
            <div class="col-md-1">
              <button class="btn btn-success float-left mt-4" id="btn_prod_bonus_order"><i class="fa fa-plus"></i></button>
            </div>
          </div>
          <input type="hidden" id="id_order_bonus_order" name="id_order_bonus_order" value="<?= $order->id; ?>">
          <input type="hidden" id="client_id_bonus_order" name="client_id_bonus_order" value="<?= $order->id_customer; ?>">
        </form>
      </div>
      <div id="productList_bonus_order">
        <?php if ($itens) : ?>
...
<script type="text/javascript" src="<?= url("theme/assets/js/pages/steps/stepiTreeUpdate.js"); ?>"></script>