...
<div class="modal fade" id="new" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable full-width" role="document">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form method="post" id="form" action="<?= url("customer/new"); ?>">
          ...
          <hr>
          <p class="text-left">Tax Rates</p>

          <div class="row mb-4">
            <div class="col-md-4">
              <div class="form-group position-relative mb-4">
                <label for="name">Name</label>
                <input type="text" class="form-control " placeholder="" name="name_tax" id="name_tax">
              </div>
          ...
          <div class="row mb-4">
            ...
            <div class="col-md-6">
              <div class="form-group position-relative mb-4 slug-set">
                <label for="id_category_customer">States</label>
            ...
            <div class="col-md-6">
              <div class="form-group position-relative mb-4 slug-set">
                <label for="id_category_customer">Country</label>
...
<script src="<?= url("theme/assets/js/pages/assistTaxRates.js"); ?>"></script>
<?php $v->end(); ?>
