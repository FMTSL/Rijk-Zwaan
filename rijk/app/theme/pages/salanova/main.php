                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="table-responsive-w-100">
                                            ...
                                            <tbody>
                                                <?php foreach ($itens as $item) : ?>
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-success" onclick="update(<?= $item->id; ?>)"><i class="fa fa-edit"></i></button>
                                                            <button onclick="deletar(<?= $item->id; ?>)" class="btn btn-danger"><i class="fa fa-times"></i></button>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                    ...
                                    <?php else : ?>
                                        <div class="alert alert-secondary text-center">No salanova registered!</div>
                                    <?php endif; ?>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" id="form" action="<?= url("salanova/new"); ?>">
                    <h4 class="card-title text-left">New <?= $title; ?></h4>
                    <hr>
                    <p class="text-left">Registration of new Salanova</p>

                    <div class="form-group position-relative mb-4 slug-set">
                        <label for="value">Discount</label>
                        <input type="number" class="form-control " required name="discount" id="discount" value="">
                    </div>
...
<script src="<?= url("theme/assets/js/pages/salanova.js"); ?>"></script>
<?php $v->end(); ?>
