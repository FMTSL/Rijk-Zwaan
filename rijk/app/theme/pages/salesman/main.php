                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <button class="btn btn-success float-right mb-3" data-bs-toggle="modal" data-bs-target="#newSalesman"><i class="fa fa-plus"></i> <?= $title; ?></button>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" id="form" action="<?= url("salesman/update"); ?>">
                    <h4 class="card-title text-left">Update <?= $title; ?></h4>
                    <hr>
                    <p class="text-left"></p>
                    <div class="form-group position-relative mb-4">
                        <label for="input_name">Name</label>
                        <input type="text" class="form-control " placeholder="Nome" required name="input_name" id="input_name">
                    </div>
                    <div class="form-group position-relative mb-4">
                    ...
                    <div class="form-group position-relative mb-4">
                        <label for="full_name">Genre</label>
                    ...
                    <div class="form-group">
                        <label for="disabledInput">Birthdate</label>
                        ...
                        <input type="hidden" id="dtp_input2" value="" name="birthdate-date" /><br />
                    </div>
                    <div class="form-group position-relative mb-4">
                    ...
                    <div class="form-group position-relative mb-4">
                        ...
                        <input type="phone" class="form-control " required name="phone" id="phone">
                    </div>
                    <div class="form-group position-relative mb-4">
...
<div class="modal fade" id="newSalesman" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" id="formNewSalesman" action="<?= url("user/salesman/new"); ?>">
                    <h4 class="card-title text-left">New <?= $title; ?></h4>
                    <hr>
                    <p class="text-left">New user registration</p>
                    <div class="form-group position-relative mb-4">
                        <label for="name">Name</label>
                        <input type="text" class="form-control " required name="salesman_input_name" id="salesman_input_name">

                    </div>
                    <div class="form-group position-relative mb-4">
                        <label for="email">Email</label>
                        <input type="text" class="form-control " required name="salesman_email" id="salesman_email">

                    </div>
                    <div class="form-group position-relative mb-4">
                        <label for="phone">Telephone</label>
                        <input type="phone" class="form-control " required name="salesman_phone" id="salesman_phone">

                    </div>
                    <div class="form-group position-relative mb-4">
                        <label for="password">Password</label>
                        <input type="password" class="form-control " name="salesman_password" id="salesman_password">
                    </div>
...
<script src="<?= url("theme/assets/js/pages/salesman.js"); ?>"></script>
<?php $v->end(); ?>
