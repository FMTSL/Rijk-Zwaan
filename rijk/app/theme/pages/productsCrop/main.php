  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <form method="post" id="form" action="<?= url("product-crop/new"); ?>">
          <h4 class="card-title text-left">New <?= $title; ?></h4>
          <hr>
          <p class="text-left">Registration of new Product Crop</p>
...
<script src="<?= url("theme/assets/js/pages/productsCrop.js"); ?>"></script>
<?php $v->end(); ?>
