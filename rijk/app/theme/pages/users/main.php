    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <form method="post" id="form" action="<?= url("user/new"); ?>">
                    <h4 class="card-title text-left">New <?= $title; ?></h4>
                    <hr>
                    <p class="text-left">New user registration</p>
                    <div class="form-group position-relative mb-4">
                        <label for="name">Name</label>
                        <input type="text" class="form-control" required name="input_name" id="input_name">
                    ...
                    <div class="form-group position-relative mb-4">
                        ...
                        <select class="form-select" id="roles" name="roles">
                            ...
                            <option value="4">Client Service</option>
                            <option value="2">Sales Representatives</option>
...
<script src="<?= url("theme/assets/js/pages/users.js"); ?>"></script>
<?php $v->end(); ?>
