...
function update(id) {
  $.get(`/packing/${id}`, function (dd) {
    console.log(dd);
    $("#new").modal("show");
    $("#form #input_name").val(dd.name);
    $("#form #id").val(dd.id);
    $("#form h4").text("Update Packaging");
    $("#form p").text(`Update Packaging ${dd.name}`);
    $("#form button").text("Update");
    $("#form").attr("action", "/packing/update");
  });
}
...
$.get(`/packaging/lists/all`, function (dd) {
