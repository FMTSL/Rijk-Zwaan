...
function update(id) {
  $.get(`/sales-unit/${id}`, function (dd) {
    console.log(dd);
    $("#new").modal("show");
    $("#form #type").val(dd.type);
    $("#form #info").val(dd.info);
    $("#form #id").val(dd.id);
    $("#form h4").text("Update Sales Unit");
    $("#form p").text(`Update Sales Unit ${dd.type}`);
    $("#form button").text("Update");
    $("#form").attr("action", "/sales-unit/update");
  });
}

function deletar(id) {
  $.ajax({
    url: `/sales-unit/delete`,
    type: "delete",
    data: { id },
    success: function (dd) {
      console.log(dd);
...
$.get(`/sales-unit/lists/all`, function (dd) {
