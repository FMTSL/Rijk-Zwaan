...
function update(id) {
  $.get(`/chemical-treatment/${id}`, function (dd) {
    console.log(dd);
    $("#new").modal("show");
    $("#form #input_name").val(dd.name);
    $("#form #id").val(dd.id);
    $("#form h4").text("Update Chemical Treatment");
    $("#form p").text(`Update Chemical Treatment ${dd.name}`);
    $("#form button").text("Update");
    $("#form").attr("action", "/chemical-treatment/update");
  });
}

function deletar(id) {
  $.ajax({
    url: `/chemical-treatment/delete`,
    type: "delete",
    data: { id },
    success: function (dd) {
      console.log(dd);
...
$.get(`/chemical-treatment/lists/all`, function (dd) {
